;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="ce2b6f3a-5fff-6d07-8c1d-7cdb0820fd50")}catch(e){}}();
module.exports = [
 ...
 */ function constructWebpackConfigFunction({ userNextConfig = {}, userSentryOptions = {}, releaseName, routeManifest, nextJsVersion, useRunAfterProductionCompileHook, vercelCronsConfigResult }) {
    ...
    return function newWebpackFunction(incomingConfig, buildContext) {
        ...
        const isServerComponentResource = (resourcePath)=>{
            ...
            return appDirPath !== undefined && normalizedAbsoluteResourcePath.startsWith(appDirPath + path.sep) && !!normalizedAbsoluteResourcePath.match(// oxlint-disable-next-line sdk/no-regexp-constructor
 ...
 */ async function captureUnderscoreErrorException(contextOrProps) {
    ...
    if (err && core.isAlreadyCaptured(err)) {
        ...
        const storedEventId = typeof err === 'object' ? err.__sentry_event_id__ : undefined;
...
function init(options) {
    ...
    const distDirName = ("TURBOPACK compile-time value", "/tmp/data4research-next") || globalWithInjectedValues._sentryRewriteFramesDistDir;
    ...
    const opts = {
        ...
        release: ("TURBOPACK compile-time value", "02e5828b35407f79bbe7a7faf15a0d88547cfe4a") || globalWithInjectedValues._sentryRelease,
...
//# debugId=ce2b6f3a-5fff-6d07-8c1d-7cdb0820fd50
//# sourceMappingURL=node_modules_%40sentry_nextjs_build_cjs_0s0iqpp._.js.map