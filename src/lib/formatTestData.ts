...
const fieldLabels: Record<string, Record<string, string>> = {
  ...
  diseaseHistory: {
    ...
    bmi: "BMI",
    idealWeightKg: "Ideal Body Weight (kg)",
    idealWeightLb: "Ideal Body Weight (lb)",
    anaemia: "Anaemia",
    jaundice: "Jaundice",
    respiratoryRate: "Respiratory Rate",
    spO2: "Oxygen Saturation (SpO2)",
    ascites: "Ascites",
    heart: "Auscultation Heart",
    lung: "Auscultation Lung",
    specialNote: "Special note or other findings of O/E",
    diseaseHistory: "Disease History",
    surgicalHistory: "Surgical or Intervention History",
  },
  imaging: {
    xray: "X-Ray",
    ctScan: "CT Scan",
